...
lab_expiry_fig,previous_year_trend_plot,current_year_trend_fig_expenses_plot,previous_year_trend_fig_expenses_plot = dash()
...
def index(request):
    ...
    context = {
        ...
        "current_year_trend_fig_expenses_plot":current_year_trend_fig_expenses_plot,
        "previous_year_trend_fig_expenses_plot":previous_year_trend_fig_expenses_plot,
...
def revenue(request):
    ...
    previous_year_trend_plot,current_year_trend_fig_expenses_plot,previous_year_trend_fig_expenses_plot= dash()
